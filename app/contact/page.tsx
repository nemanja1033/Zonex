    ...
    <>
      ...
      <section className="section-divider section section-surface">
        <Container className="grid gap-10 md:grid-cols-[1.2fr_0.8fr]">
          <form className="lux-border lux-sheen space-y-6 rounded-3xl bg-[linear-gradient(160deg,rgba(255,255,255,0.96),rgba(247,242,236,0.9))] p-8 shadow-[0_24px_60px_rgba(12,17,23,0.12)]">
            <div>
          ...
          <div className="lux-border lux-sheen space-y-6 rounded-3xl bg-[linear-gradient(160deg,rgba(255,255,255,0.7),rgba(247,242,236,0.65))] p-8 shadow-[0_20px_50px_rgba(12,17,23,0.12)] backdrop-blur">
            <div>
