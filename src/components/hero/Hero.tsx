...
export default function Hero() {
  ...
  return (
    <section ref={heroRef} className="relative min-h-screen flex flex-col overflow-hidden">
      ...
      {/* Grain overlay - above slideshow (hidden on mobile for performance) */}
      <div
        className="grain-overlay absolute inset-0 z-[2] opacity-[0.04] pointer-events-none"
        style={{
      ...
      {/* Hero radial glow behind title - subtle accent (hidden on mobile for performance) */}
      <div
        className="hero-glow absolute top-1/2 left-1/3 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[400px] opacity-[0.08] pointer-events-none z-[3]"
        style={{
