...
export default function ProjectListItem({ project }: ProjectListItemProps) {
  return (
    <motion.div
      ...
      className="group relative grid gap-6 rounded-2xl border-b border-border px-4 py-8 transition-colors duration-300 hover:bg-white/70 md:grid-cols-[200px_1.2fr_0.8fr]"
    >
