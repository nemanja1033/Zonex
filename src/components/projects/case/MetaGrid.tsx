...
export default function MetaGrid({ project }: MetaGridProps) {
  return (
    <div className="grid gap-6 rounded-3xl border border-border/70 bg-[linear-gradient(160deg,rgba(255,255,255,0.96),rgba(247,242,236,0.9))] p-6 shadow-[0_22px_55px_rgba(12,17,23,0.12)] md:grid-cols-3">
