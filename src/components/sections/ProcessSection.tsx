        ...
        <div className="mt-12 grid gap-6 md:grid-cols-4">
          {processSteps.map((step, index) => (
            <Reveal key={step.title} delay={index * 0.05}>
              <div className="lux-border lux-sheen group relative overflow-hidden rounded-3xl bg-[linear-gradient(150deg,rgba(255,255,255,0.92),rgba(246,240,232,0.86))] p-6 shadow-[0_20px_45px_rgba(12,17,23,0.1)] transition-transform duration-300 hover:-translate-y-1">
