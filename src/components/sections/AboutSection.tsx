      ...
      <Container>
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          {site.values.map((item, index) => (
            <Reveal key={item.title} delay={index * 0.08} variant="fadeUp">
              <div className="group card-surface relative overflow-hidden rounded-3xl p-6 shadow-[0_22px_55px_rgba(3,6,12,0.4)] transition-all duration-300 hover:-translate-y-1">
