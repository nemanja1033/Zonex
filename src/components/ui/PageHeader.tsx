...
export default function PageHeader({ eyebrow, title, subtitle }: PageHeaderProps) {
  ...
  return (
    <section className="relative overflow-hidden bg-[#1C1C1E] pt-32 pb-16 lg:pt-40 lg:pb-20">
      ...
      {/* Glow accent */}
      <div className="absolute top-0 left-1/4 w-[500px] h-[500px] bg-[#FF3B30]/5 rounded-full blur-[150px] pointer-events-none" />
      ...
      <Container className="relative z-10">
        ...
        >
          <span className="text-[10px] font-medium uppercase tracking-[0.25em] text-[#FF3B30]">01</span>
        ...
        {/* Decorative line */}
        <motion.div
          className="mt-8 h-px w-24 bg-gradient-to-r from-[#FF3B30]/50 to-transparent"
